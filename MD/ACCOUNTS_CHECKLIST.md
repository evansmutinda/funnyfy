...
| Item | URL / path | Note |
|------|------------|------|
| Admin dashboard | `https://funnyfy-staging.vercel.app/admin/login` | Finance, Growth, Users, Jobs — `MD/FUNNYFY_FLOW.md` |
...
See also: `MD/STATUS.md`, `MD/FUNNYFY_FLOW.md`, set `ADMIN_USER_IDS` / `admin_users` in Vercel
