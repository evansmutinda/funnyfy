...
const LEGACY_STYLES: Record<string, StyleConfig> = {
  ...
  victorian: {
    ...
    prompt:
      "Using the uploaded image as the only facial and identity reference, transform the subject into a humorous, highly recognizable 3D caricature set in the late Victorian era, 1890–1901.\n\nPreserve the subject's exact identity, race/ethnicity, gender, skin tone, facial structure, eyes, nose, mouth, proportions, hair characteristics and distinctive features. Keep the person clearly recognizable. Do not change their race, ethnicity or identity.\n\nCreate a polished premium 3D caricature with tasteful exaggeration: slightly enlarged head, subtly exaggerated facial features, expressive eyes and playful personality while maintaining strong facial likeness. Avoid grotesque distortion.\n\nDress the subject in authentic 1890–1901 Victorian clothing appropriate to their gender, race/ethnic background and historical setting, including period-accurate suits, waistcoats, high collars, cravats, long coats, Victorian dresses, skirts, hats, gloves and appropriate accessories.\n\nMake the entire environment historically authentic to 1890–1901, including architecture, streets, interiors, furniture, transportation, lighting, signage, props and technology. Use appropriate Victorian buildings, cobblestone streets, horse-drawn carriages, period shops, gas or early electric lighting, Victorian interiors and other genuine late-19th-century details. No modern objects, architecture, clothing, hairstyles or technology.\n\nUse realistic 3D materials, detailed fabrics, believable skin and hair, cinematic lighting, soft depth of field and premium studio-quality rendering.\n\nApply an authentic 1890–1901 portrait-photography aesthetic with restrained sepia/monochrome tones, subtle film grain, soft contrast and aged photographic character. Do not make it look like a modern photo with a sepia filter.\n\nThe final result should look like a humorous Victorian-era portrait of the actual uploaded person, combining strong identity likeness, preserved race/ethnicity, tasteful caricature and an immersive historically accurate 1890–1901 environment.",
    model: SEEDREAM_4_5,
    enabled: true,
    premium: false,
  },
